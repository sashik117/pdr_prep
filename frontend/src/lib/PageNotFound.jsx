      ...
      <div className="max-w-md w-full">
        <div className="text-center space-y-6">
          ...
          <div className="space-y-3">
            <h2 className="text-2xl font-medium text-slate-800">Сторінку не знайдено</h2>
            <p className="text-slate-600 leading-relaxed">
              Сторінка <span className="font-medium text-slate-700">"{pageName}"</span> не існує або була переміщена.
            </p>
          </div>
