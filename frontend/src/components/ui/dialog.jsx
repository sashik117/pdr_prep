...
const DialogContent = React.forwardRef((/** @type {any} */{ className, children, hideCloseButton = false, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay />
    <DialogPrimitive.Content
      ...
      {...props}>
      <VisuallyHidden.Root>
        <DialogPrimitive.Title>Діалогове вікно</DialogPrimitive.Title>
        <DialogPrimitive.Description>Модальне вікно з вмістом сторінки.</DialogPrimitive.Description>
      </VisuallyHidden.Root>
      {children}
      {!hideCloseButton ? (
...
const DialogHeader = (/** @type {any} */{ className, ...props }) => (
  <div className={cn("flex flex-col space-y-1.5 text-center sm:text-left", className)} {...props} />
)
DialogHeader.displayName = "DialogHeader"

const DialogFooter = (/** @type {any} */{ className, ...props }) => (
