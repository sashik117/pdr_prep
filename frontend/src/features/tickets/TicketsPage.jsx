...
import { Check, ChevronDown, Crown, FileQuestion, Lock, PlayCircle, Ticket } from 'lucide-react';
            ...
            return (
              <motion.div key={ticketItem.ticket_number} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: index * 0.015 }}>
                <Link to={href} className="block h-full">
                  <Card className="h-full border-slate-200 shadow-none transition-colors hover:border-primary/35 dark:border-slate-800 dark:hover:border-sky-500/35">
                    <CardContent className="space-y-3 p-4 text-left">
                      ...
                      <p className="inline-flex items-center gap-2 text-xs font-medium uppercase tracking-[0.16em] text-emerald-600 dark:text-emerald-300">
