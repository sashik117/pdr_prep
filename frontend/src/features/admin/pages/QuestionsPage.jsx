...
import { CheckCircle2, FileQuestion, ImageIcon, PencilLine, Search, ShieldCheck } from 'lucide-react';
  ...
  const saveQuestion = () => {
    ...
    questionMutation.mutate({
      ...
      payload: {
        ...
        images: textToLines(draft.imagesText),
  ...
  return (
    <div>
      ...
      <div className="mt-6 grid gap-6 xl:grid-cols-[1fr_0.92fr]">
        ...
        <Card className="border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900/70">
          <CardHeader>
            <CardTitle className="text-lg font-semibold">Редагування питання</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            {!selectedQuestion || !draft ? (
              <EmptyState text="Оберіть питання в таблиці." />
            ) : (
              <>
                ...
                <QuestionImagesPreview images={textToLines(draft.imagesText)} questionId={selectedQuestion.id} />
...
function QuestionImagesPreview({ images = [], questionId }) {
